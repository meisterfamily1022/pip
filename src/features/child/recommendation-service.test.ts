...
const toy = (id: number, categories: ChildToy['categories'], available = true, archived = false): ChildToy => ({ id, name: `Toy ${id}`, imageUri: null, originalImageUri: null, enhancedImageUri: null, preferredImageVariant: 'original', aiMetadataStatus: 'manual', aiAnalysisId: null, aiSchemaVersion: null, aiConsentAt: null, aiConfirmedAt: null, roomId: 1, storageSpotId: 1, cleanupDifficulty: 'easy', adultHelpRequired: false, categories, isAvailable: available, isArchived: archived, createdAt: '', updatedAt: '', imageRemotePath: null, roomName: 'Room', storageSpotName: 'Shelf' });
