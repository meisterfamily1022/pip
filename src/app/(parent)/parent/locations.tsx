...
const styles = StyleSheet.create({ content: { gap: 16, padding: 24, paddingBottom: 48, paddingTop: 56 }, title: { fontSize: 32, fontWeight: '700' }, helper: { color: '#4B4B55', fontSize: 17, lineHeight: 25 }, rooms: { gap: 16 }, room: { backgroundColor: '#F6F7FA', borderRadius: 14, gap: 14, padding: 16 }, row: { gap: 12 }, roomName: { fontSize: 22, fontWeight: '700' }, actions: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, spots: { gap: 10 }, spot: { alignItems: 'center', flexDirection: 'row', gap: 10, justifyContent: 'space-between' }, spotName: { flex: 1, fontSize: 17 }, emptySpots: { color: '#5C5C66', fontStyle: 'italic' }, error: { color: '#C62828' }, });
